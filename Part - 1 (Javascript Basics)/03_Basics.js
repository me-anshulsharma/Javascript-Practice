...
// String can be created as primitives from string literals (directly using "...." or = String("...........")), or as objects using the "new String()" constructor
...
// const fullName = new String("Anshul Sharma")
...
// let sentence = "Hey, this is Anshul Sharma! I am a student at VIT University"
// console.log(sentence.charAt(5)) // accessing a particular character
...
// String.prototype.codePointAt(): Returns a nonnegative integer Number that is the code point value of the UTF-16 encoded code point starting at the specified pos.
...
// String.prototype.indexOf(): Returns the index within this string of the first occurrence of searchValue, or -1 if not found.

// String.prototype.isWellFormed(): Returns a boolean indicating whether this string contains any lone surrogates.

// String.prototype.lastIndexOf(): Returns the index within this string of the last occurrence of searchValue, or -1 if not found.
...
// String.prototype.padEnd(): Pads the current string from the end with a given string and returns a new string of the length targetLength.

// String.prototype.padStart(): Pads the current string from the start with a given string and returns a new string of the length targetLength.

// String.prototype.repeat(): Returns a string consisting of the elements of the object repeated count times.

// String.prototype.replace(): Used to replace occurrences of searchFor using replaceWith. searchFor may be a string or Regular Expression, and replaceWith may be a string or function.

// String.prototype.replaceAll(): Used to replace all occurrences of searchFor using replaceWith. searchFor may be a string or Regular Expression, and replaceWith may be a string or function.
...
// String.prototype.toLocaleUpperCase(): The characters within a string are converted to uppercase while respecting the current locale.
...
// String.prototype.toWellFormed(): Returns a string where all lone surrogates of this string are replaced with the Unicode replacement character U+FFFD.
